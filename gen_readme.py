        ...
        for filename in os.listdir(folder_path):
            ...
            if os.path.isfile(file_path) and filename.endswith(
                ...
                if block:
                    ...
                    level = re.search(r"Level\s*:\s*(.+)", comment)
...
def collect_all_problems():
    ...
    for oj in OJ_LIST:
        # 프로젝트 루트 바로 아래의 boj/, programmers/ 사용
        oj_path = oj
        ...
        for oj, problems in problems_by_oj.items():
            ...
            for oj, number, title, level, tags, link, _ in problems:
                ...
                f.write(
                    ...
                    f"[코드](https://github.com/yonghun16/Algorithm/tree/main/{oj}/{oj}_{number}_{encoded_title}) |\n"
                )
